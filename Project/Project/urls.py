...
urlpatterns = [
    ...
    path('chatbot/chatbot_submit', views.chatbot_view, name='chatbot_submit'),
    path('chatbotInterno/submit', views.chatbotInterno_view, name='chatbotInterno_submit'),
    path('chatbotInterno/', views.chatbotInterno, name='chatbotInterno'),
] 
